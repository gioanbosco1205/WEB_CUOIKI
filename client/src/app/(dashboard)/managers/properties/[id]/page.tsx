  ...
  return (
    <div className="dashboard-container">
      ...
      <Header
        ...
        subtitle="Quản lý người thuê và hợp đồng của phòng này"
      />
      ...
      <div className="w-full space-y-6">
        <div className="mt-8 bg-white rounded-xl shadow-md overflow-hidden p-6">
          <div className="flex justify-between items-center mb-4">
            <div>
              <h2 className="text-2xl font-bold mb-1">Danh sách người thuê</h2>
              <p className="text-sm text-gray-500">
              Xem và quản lý người thuê của phòng này.
              </p>
            </div>
            <div>
              <button
              ...
              <TableBody>
                {leases?.map((lease) => (
                  <TableRow key={lease.id} className="h-24">
                    ...
                    <TableCell>{lease.rent} VNĐ</TableCell>
                    <TableCell>
                      <span

...
const PropertyOverview = ({ propertyId }: PropertyOverviewProps) => {
  console.log("PropertyOverview called with propertyId:", propertyId);
  const {
    data: property,
    isError,
    isLoading,
  ...
  return (
    <div>
        ...
        <div className="flex justify-between items-center gap-4 px-5">
          <div>
            ...
            <div className="font-semibold">
              {property.pricePerMonth.toLocaleString()}VND/ Tháng
            </div>
          </div>
          ...
          <div className="border-l border-gray-300 h-10"></div>
          <div>
            <div className="text-sm text-gray-500">Nhà tắm</div>
          ...
          <div>
            ...
            <div className="font-semibold">
              {property.squareFeet.toLocaleString()} m2
            </div>
          </div>
        </div>
      </div>
      ...
      {/* Summary */}
      <div className="my-16">
        <h2 className="text-xl font-semibold mb-5"> {property.name}</h2>
